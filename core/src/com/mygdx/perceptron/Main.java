...
public class Main extends ApplicationAdapter implements GestureDetector.GestureListener {
	...
	public HashMap createColorMap() {
		HashMap<String, Color> colorMapInstance = new HashMap<String, Color>();
		colorMapInstance.put("WHITE", new Color(1, 1, 1, 1));
		colorMapInstance.put("BLACK", new Color(0, 0, 0, 1));
		colorMapInstance.put("BLUE", new Color(0, 0, 1, 1));
	...
	void drawTexts(SpriteBatch spriteBatch, BitmapFont font) {
		spriteBatch.begin();
		font.draw(spriteBatch, "test", 20, 20);
		spriteBatch.end();
	}
